...
class _OutboundCollectPageState extends State<OutboundCollectPage>
  ...
  void _initializePage() {
    ...
    _bloc.add(
      OutboundCollectEvent.initialize(
        task: task,
        workStation: widget.workStation,
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              ...
              _bloc.add(OutboundCollectEvent.searchTaskItems(searchKey: ''));
            },
          ),
        ),
        onChanged: (value) {
          _bloc.add(OutboundCollectEvent.searchTaskItems(searchKey: value));
        },
      ),
    );
  }
      ...
      loaded:
          (
            ...
            return OutboundCollectScanWidget(
              ...
              currentInventory: currentInventory?.isNotEmpty == true
                  ? currentInventory!.first
                  : null,
              onScanCode: (code) {
                _bloc.add(OutboundCollectEvent.processScanCode(content: code));
              },
              ...
              onResetScan: () {
                _bloc.add(const OutboundCollectEvent.resetScanState());
              },
            );
          },
      orElse: () => const SizedBox.shrink(),
