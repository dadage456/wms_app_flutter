      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('暂无采集记录', style: TextStyle(fontSize: 16, color: Colors.grey)),
            SizedBox(height: 8),
            Text(
              '请先扫描库位和物料进行采集',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (record.sn != null) _buildInfoRow('序列号', record.sn!),
                if (record.pdate != null) _buildInfoRow('生产日期', record.pdate!),
